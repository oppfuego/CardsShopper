  ...
  return (
    <div className="terms-conditions1">
      ...
      <div className="terms-content">
        <h1 className="terms-conditions2">{`Terms & Conditions`}</h1>
        <div className="please-refer-to3">{`Please refer to our Terms and Conditions for further details regarding the use and redemption of the Shoes & Wallet Gift Card.`}</div>
      </div>
      <main className="terms-body">
        ...
        <div className="contact-us-container">
          <h1 className="contact-us6">
            <ol className="contact-us7">
              <li>Contact Us</li>
            </ol>
          </h1>
      ...
      <FooterDesktop
        group="pending_I560:7527;4:21124"
